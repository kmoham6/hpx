...
namespace hpx::execution::experimental {
    ...
    public:
        ...
        explicit adaptive_core_chunk_size(
          hpx::chrono::steady_duration const& rel_time,
            ...
            // hpx::chrono::steady_duration const& rel_time3,
             ...
             , min_time2_(rel_time.value().count())
        ...
        friend std::size_t tag_invoke(hpx::parallel::execution::processing_units_count_t, adaptive_core_chunk_size const& params,
        ...
        // hpx::parallel::execution::processing_units_count(exec, iteration_duration, count);
            ...
            // std::cout << "this is number of cores:" << (count * us.count()) / min_time1_ <<std::endl;
            // std::cout << "this is number of cores:" << num_cores <<std::endl;
            // std::cout << "this is min_time1:" << min_time1_ <<std::endl;
            // std::cout << "this is min_time2:" << min_time2_ <<std::endl;
            #endif
            
            #ifdef ENABLE_PRINT
            // std::cout << "this is t_time / min_time1_: " << t_time / min_time1_<<std::endl;
            // std::cout << "this is t_time / min_time2_: " << t_time / min_time2_<<std::endl;
            #endif
            // std::uint64_t num_iteration2 = t2 / us.count();
            // std::uint64_t num_iteration3 = t3 / us.count();
        ...
        template <typename Executor>
        friend std::size_t tag_invoke(hpx::parallel::execution::get_chunk_size_t, adaptive_core_chunk_size const& params,
            Executor&&, hpx::chrono::steady_duration const& iteration_duration, std::size_t cores, std::size_t count) noexcept
        {
            ...
            std::size_t cores, std::size_t count) const noexcept
        {
            ...
            // std::cout <<"\n" << "cores that are used to calculate chunks: " << cores << std::endl;
            #endif
    ...
    private:
        ...
        {
            ar& chunk_size_& min_time1_& min_time2_;
        }
        /// \endcond
